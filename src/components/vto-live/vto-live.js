...
const VirtualTryOnLive = () => {
  ...
  const handleFoundationClick = (shadeColor, productName) => {
  ...
  const handleLipstickClick = (lipstickId, productName) => {
  ...
  const handleBlushClick = (blushId, productName) => {
  ...
  const handleEyeShadowClick = (shadeColor, isGlitter, productName) => {
    let productImage = '../images/catalog/eyeshadow/'+ productName + '.png';
    setBuyImage(productImage);
            ...
            { showFoundationProducts ? (
              ...
              <div className="product-options-container">
                ...
                <button className="reset-option" onClick={resetFoundation}></button>
                  ...
                  <button className="makeup-option" onClick={() => handleFoundationClick('#dba779','NYX-true-beige')} title='True Beige' style={{ background: '#dba779', border: selectedFoundation === '#dba779' ? '2px solid rgb(100, 99, 99)' : 'v#dba779' }}></button>
