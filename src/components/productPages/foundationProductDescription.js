     ...
     useEffect(() => {
             const fetchAllData = async () => {
                 try {
                     ...
                     const mostViewedResponse = await fetch('http://127.0.0.1:5000/most-viewed-foundation');
    ...
    return (
        <div>
            ...
            <div className="hyperlinks" style={{ margin: "20px 0", padding: "0 40px", textAlign: "left", color: "black" }}>
                ...
                <Link to="/foundation-catalog" className="hyperlink" style={{ color: "#575555" }}> Foundation</Link> / 
...
export default FoundationProductDescription;
