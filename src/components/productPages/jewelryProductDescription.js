...
const JewelryProductDescription = () => {
     ...
     useEffect(() => {
             const fetchAllData = async () => {
                 try {
                     ...
                     const mostViewedResponse = await fetch('http://127.0.0.1:5000/most-viewed-jewelry');
    ...
    return (
        <div>
            ...
            <div className="hyperlinks" style={{ margin: "20px 0", padding: "0 40px", textAlign: "left", color: "black" }}>
                <Link to="/accessory-catalog" className="hyperlink" style={{ color: "#575555" }}>Accessories</Link> /
                <Link to="/accessory-catalog" className="hyperlink" style={{ color: "#575555" }}> Jewelry</Link> / 
            ...
            <div className="most-viewed-section">
                <hr className="section-divider" />
                <h2 className="section-title">Frequently Accessed Jewelry</h2>
                <div className="most-viewed-row">
                    {mostViewed.map((item) => (
                        <div key={item.productID} className="most-viewed-card">
                            <div className="most-viewed-image-container">
                            ...
                            <div className="most-viewed-content">
                                ...
                                <div className="most-viewed-footer">
                                    ...
                                    <Link to={`/jewelryProductDescription/${item.productID}`} className="most-viewed-link">View Details</Link>
                                </div>
                            </div>
                        </div>
                    ))}
...
export default JewelryProductDescription;
